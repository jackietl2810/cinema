                    ...
                    <div class="panel-body">
                        <form class="form-horizontal">
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="datestart">Từ ngày:</label>
                                <div class="col-sm-6">
                                    <input type="date" class="form-control" id="datestart">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="dateend">Đến ngày:</label>
                                <div class="col-sm-6">
                                    <input type="date" class="form-control" id="dateend">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="addpoint"></label>
                                <div class="col-sm-9">
                                    <div class="radio col-sm-9">
                                        <input type="radio" name="gender" id="addpoint" checked>
                                        <label for="addpoint">
                                            Lịch sử cộng điểm
                                        </label>
                                    </div>
                                    <div class="radio col-sm-9">
                                        <input type="radio" name="gender" id="usepoint">
                                        <label for="usepoint">
                                            Lịch sử dùng điểm
                                        </label>
                                    </div>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>21/01/2017 8:08</td><td>Harry Potter và bảo bối tử thần</td><td>9000</td>
                                </tr>
                                <tr>
                                    <td>21/01/2017 8:08</td><td>Harry Potter và bảo bối tử thần</td><td>9000</td>
                                </tr>
